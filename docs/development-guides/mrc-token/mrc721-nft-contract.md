---
sidebar_position: 3
title: MRC 721  NFT Contract
---

# MRC 721 Spec: Non Fungible Tokens

MRC 721 is a specification for non-fungible tokens based on WASM.
...
to any standard MRC 721 contract.
...
as is by all MRC 721 contracts. Note that all tokens must have an owner, 
...
the MRC 721Receiver interface. The `msg` will be passed to the recipient 
...
any contract that wishes to manage MRC 721 tokens. This is generally *not*
implemented by any MRC 721 contract.
...
values without violating the MRC 721 spec, and clients should not rely on
