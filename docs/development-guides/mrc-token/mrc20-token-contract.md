---
sidebar_position: 1
title: MRC 20 Token Contract
---

# MRC 20 Spec: Fungible Tokens

MRC 20 is a specification for fungible tokens based on WASM.
The name and design is loosely based on Ethereum's ERC 20 standard,
...
to any standard MRC 20 contract.
...
any contract that wishes to manage MRC 20 tokens. This is generally *not*
implemented by any MRC 20 contract.
...
accounts. This is not as essential as with MRC 20 as we use `Send`/`Receive`
...
There was an issue with race conditions in the original MRC 20 approval spec.
